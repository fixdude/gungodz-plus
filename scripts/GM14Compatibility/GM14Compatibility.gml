...
function d3d_model_create() {
	...
	var model = [ undefined,				// point buffer
				  ...
				  undefined,				// tri list buffer			  
				  $00010000,				// colour used when creating
...
/// @param xport The x position of the left of the area the view occupies on-GScreen.
/// @param yport The y position of the top of the area the view occupies on-GScreen.
/// @param wport The width of the area the view occupies on-GScreen.
/// @param hport The height of the area the view occupies on-GScreen.
