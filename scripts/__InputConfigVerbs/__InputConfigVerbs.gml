function __InputConfigVerbs()
{
	...
	// Movement
	InputDefineVerb(INPUT_VERB.UP,
	"up", [vk_up, "W"], [-gp_axislv, gp_padu]);
	InputDefineVerb(INPUT_VERB.DOWN,
	"down", [vk_down,"S"], [gp_axislv, gp_padd]);
	InputDefineVerb(INPUT_VERB.LEFT,
	"left", [vk_left, "A"], [-gp_axislh, gp_padl]);
	InputDefineVerb(INPUT_VERB.RIGHT,
	"right", [vk_right, "D"], [gp_axislh, gp_padr]);
	...
	InputDefineVerb(INPUT_VERB.SHOOT, "shoot", vk_lcontrol, gp_face3, faceB);
	InputDefineVerb(INPUT_VERB.NEXT_WEAPON, "next weapon", vk_lcontrol, gp_face3, faceB);
	InputDefineVerb(INPUT_VERB.MELEE, "melee", vk_shift, gp_face4);
